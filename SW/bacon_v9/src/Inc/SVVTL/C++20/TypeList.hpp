...
public:
  ...
  static consteval auto accumulate([[maybe_unused]] auto func) { return (TypeList<>{} + ... + func(TypeBox<Ts>{})); }
...
private:
  static consteval bool is_unique_([[maybe_unused]] auto func) { return true; }
